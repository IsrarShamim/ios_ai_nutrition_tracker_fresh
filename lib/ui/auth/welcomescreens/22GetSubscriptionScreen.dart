...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  // Only Monthly, Quarterly, and Yearly plans.
  int _selectedPlanIndex = 0;
  final List<String> _plans = ['Monthly', 'Quarterly', 'Yearly'];
  final List<String> _prices = ['\$9.99', '\$24.99', '\$79.99'];
  // Discount exists only on Monthly and Yearly.
  final List<String> _discounts = ['', '30% OFF', '55% OFF'];
      ...
      child: SafeArea(
        child: Stack(
          children: [
            ...
            // DO NOT TOUCH the subscribe button!
            Positioned(
              bottom: 0,
              left: 0,
              right: 0,
    ...
    return Padding(
      ...
      child: Row(
        children: List.generate(_plans.length, (index) {
          return Expanded(
            flex: 1, // Explicitly set flex to 1 to ensure equal width
