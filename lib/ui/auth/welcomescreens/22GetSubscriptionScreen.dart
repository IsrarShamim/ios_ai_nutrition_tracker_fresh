...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
                  ...
                  const FeatureSection(
                    ...
                    features: [
                      FeatureItem(
                        ...
                        description:
                            'Your personal AI nutritionist to guide meal choices.',
                      ),
                      FeatureItem(
                        title: 'Photo Food Tracking',
                        description:
                            'Snap a meal photo to log nutritional details.',
                      ),
                      FeatureItem(
                        title: 'AI Nutrition Analysis',
                        description:
                            'Receive smart analysis of your meal\'s nutrition.',
                      ),
                      FeatureItem(
                        title: 'AI Recipes',
                        description:
                  ...
                  const FeatureSection(
                    ...
                    features: [
                      FeatureItem(
                        ...
                        description:
                            'Instant food recognition with barcode scanning.',
                      ),
                      FeatureItem(
                        title: '3M+ Food Database',
                        description:
                            'Access a comprehensive global food database.',
                      ),
                      FeatureItem(
                        title: 'Micro Nutrient Tracking',
                        description:
                            'Effortlessly monitor essential vitamins and minerals.',
                      ),
                    ],
                  ...
                  const FeatureSection(
                    ...
                    features: [
                      FeatureItem(
                        ...
                        description:
                            'Custom diet plans tailored to your unique goals.',
                      ),
                      FeatureItem(
                        title: 'Smarter Every Day',
                        description:
                            'Actionable nutrition insights to help you stay on track.',
                      ),
                      FeatureItem(
                        title: 'Visualize Your Progress',
                        description:
                            'Interactive charts to monitor your nutritional journey.',
                      ),
                    ],
  ...
  Future<void> _startPurchase() async {
    ...
    final matchingProducts =
        _subscriptionService.products.where((p) => p.id == selectedProductId);

    if (matchingProducts.isEmpty) {
      _showErrorAlert('Product not EQUU');
      return;
    }
    ...
    try {
      final success =
          await _subscriptionService.buySubscription(product, context);
      if (!success) {
